...
abstract class PHPUnit_Framework_TestCase extends PHPUnit_Framework_Assert implements PHPUnit_Framework_Test, PHPUnit_Framework_SelfDescribing {
	 ...
	 * @param bool       $callOriginalConstructor Can be used to disable the call to the original class'
	 *                                            constructor.
	 * @param bool       $callOriginalClone       Can be used to disable the call to the original class' clone
	 *                                            constructor.
	 * @param bool       $callAutoload            Can be used to disable __autoload() during the generation of the
	 *                                            test double class.
