 ...
 */
require_once($path . 'vendor' . DS . 'firebase' . DS . 'php-jwt' . DS . 'Exceptions' . DS . 'SignatureInvalidException.php');
...
class JWT {
	 ...
	 * @throws BeforeValidException         Provided JWT is trying to be used before it's eligible as defined by
	 *                                      'nbf'
	 * @throws BeforeValidException         Provided JWT is trying to be used before it's been created as defined
	 *                                      by 'iat'
