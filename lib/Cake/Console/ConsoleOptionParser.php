...
class ConsoleOptionParser {
	 ...
	 *
	 * @param ConsoleInputOption|string $name    The long name you want to the value to be parsed out as when options
	 *                                           are parsed. Will also accept an instance of ConsoleInputOption
	 ...
	 *   An exception will be raised when parse() encounters an invalid value.
	 *
	 * @param ConsoleInputArgument|string $name   The name of the argument. Will also accept an instance of
	 ...
	 *    it will be used.
	 *
	 * @param ConsoleInputSubcommand|string $name    Name of the subcommand. Will also accept an instance of
