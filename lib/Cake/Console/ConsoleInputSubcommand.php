...
class ConsoleInputSubcommand {
	 ...
	 * @param ConsoleOptionParser|array $parser A parser for this subcommand. Either a ConsoleOptionParser, or an array
	 *                                          that can be used with ConsoleOptionParser::buildFromArray()
	 */
