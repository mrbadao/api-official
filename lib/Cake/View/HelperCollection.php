...
class HelperCollection extends ObjectCollection implements CakeEventListener {
	 ...
	 *                                   the method you are calling. If an instance of CakeEvent is provided, then then
	 *                                   Event name will parsed to get the callback name. This is done by getting the
	 *                                   last word after any dot in the event name
