...
class HtmlHelper extends AppHelper {
	 ...
	 *
	 * @param string|array $configFile String with the config file (load using PhpReader) or an array with file and
	 *                                 reader name
	 ...
	 *                              CSS stylesheets. If `$path` is prefixed with '/', the path will be relative to the
	 *                              webroot of your application. Otherwise, the path will be relative to your CSS path,
	 *                              usually webroot/css.
	 ...
	 * @param array|bool   $options Array of options, and html attributes see above. If boolean sets $options['inline']
	 *                              = value
	 *
	 ...
	 *                                     Can also be an array, see above for details.
	 *
