...
class Validation {
	 ...
	 *                            credit cards if an array is used only the values of the array are checked. Example:
	 *                            array('amex', 'bankcard', 'maestro')
	 ...
	 *                               used as an array it must be passed as array('check1' => value, 'operator' =>
	 *                               'value', 'check2' -> value)
