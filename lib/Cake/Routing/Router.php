...
class Router {
	 ...
	 *                        element should match. Also contains additional parameters such as which routed parameters
	 *                        should be shifted into the passed arguments. As well as supplying patterns for routing
	 *                        parameters.
	 *
	 * @see routes
	 ...
	 *
	 * @param string $route    A string describing the template of the route
	 * @param array  $defaults An array describing the default route parameters. These parameters will be used by
	 *                         default and can supply routing parameters that are not dynamic. See above.
	 * @param array  $options  An array matching the named elements in the route to regular expressions which that
	 *                         element should match. Also contains additional parameters such as which routed
	 *                         parameters should be shifted into the passed arguments, supplying patterns for routing
