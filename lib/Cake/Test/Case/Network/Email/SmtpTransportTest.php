...
class SmtpTransportTest extends CakeTestCase {
	 ...
	 * @expectedExceptionMessage SMTP server did not accept the connection or trying to connect to non TLS SMTP server
	 *                           using TLS.
	 * @return void
	 */
	 ...
	 *
	 * @expectedException SocketException
	 * @expectedExceptionMessage AUTH command not recognized or not implemented, SMTP server may not require
	 *                           authentication.
	 * @return void
	 */
