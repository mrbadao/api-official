...
// @codingStandardsIgnoreEnd
	 ...
	 *
	 * @return bool true if the variable exists (if is a not loaded model association it will be created), false
	 *              otherwise
	 */
	...
	/**
	 * This function is a convenient wrapper class to create(false) and, as the name suggests, clears the id, data, and
	 * validation errors.
	 *
	 ...
	 * @param array  $query Option fields (conditions / fields / joins / limit / offset / order / page / group /
	 *                      callbacks)
	 *
	 ...
	 * @param bool  $primary If this is the primary model results (results from model where the find operation was
	 *                       performed)
	 *
	 ...
	 * - `atomic`: If true (default), returns boolean. If false returns array.
	 * - `fieldList`: Equivalent to the $fieldList parameter in Model::save()
	 * - `deep`: If set to true, not only directly associated data , but deeper nested associated data is validated as
	 * well.
	 *
	 * Warning: This method could potentially change the passed argument `$data`,
	 * If you do not want this to happen, make a copy of `$data` before passing it
	 ...
	 *
	 * @param array|string $options An optional array of custom options to be made available in the beforeValidate
	 *                              callback
	 *
