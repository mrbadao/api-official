...
class TreeBehavior extends ModelBehavior {
	 ...
	 *
	 * Overridden to transparently manage setting the lft and rght fields if and only if the parent field is included
	 * in the parameters to be saved.
	 *
	 ...
	 *
	 * Overridden to transparently manage setting the lft and rght fields if and only if the parent field is included
	 * in the parameters to be saved. For newly created nodes with NO parent the left and right field values are set
	 * directly by this method bypassing the setParent logic.
	 *
	 * @param Model $Model   Model using this behavior
	 * @param array $options Options passed from Model::save().
	 *
	 ...
	 * 'parent' the values of the parent_id field will be used to populate the left and right fields. The
	 ...
	 * If false is passed for the id parameter, top level, or all (depending on direct parameter appropriate) are
	 * counted.
	 *
	 * @param Model        $Model     Model using this behavior
	 * @param int|string   $id        The ID of the record to read
	 ...
	 * @param string|array $fields    Either a single string of a field name, or an array of field names
	 * @param string       $order     SQL ORDER BY conditions (e.g. "price DESC" or "name ASC") defaults to the tree
	 *                                order
